...
function MainAppContent() {
  ...
  const activeTab = (location.pathname.substring(1) || 'pantry') as 'pantry' | 'recipe' | 'stats' | 'settings';
  ...
  return (
    ...
    >
      ...
      <ModalsContainer
        ...
        stopRecording={stopRecording}
        isScanningBarcode={isScanningBarcode}
        setIsScanningBarcode={(val) => {
          setIsScanningBarcode(val);
          if (!val && audioParsedProducts && audioParsedProducts.length > 0) {
