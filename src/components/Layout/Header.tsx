...
export function Header({ activeTab, handleTabChange, isGenerating, setShowAddSheet }: HeaderProps) {
  return (
    <header className="hidden sm:block bg-white/70 dark:bg-stone-900/70 backdrop-blur-xl border-b border-stone-200/50 dark:border-stone-800/50 sticky top-0 z-10 transition-colors duration-200 supports-[backdrop-filter]:bg-white/60 supports-[backdrop-filter]:dark:bg-stone-900/60">
