    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-4 sm:p-0">
        ...
        <motion.div
          ...
          className="bg-white dark:bg-stone-900 w-full max-w-md rounded-t-3xl sm:rounded-2xl shadow-2xl relative z-10 overflow-hidden"
          drag="y"
        ...
        >
          ...
          <div className="p-6">
            ...
            <p className="text-stone-600 dark:text-stone-400 mb-6">
              Quanti <span className="font-bold text-stone-900 dark:text-stone-100">{product.name}</span> vuoi {isConsume ? 'consumare' : 'buttare'}?
